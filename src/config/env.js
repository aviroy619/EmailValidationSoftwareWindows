...
module.exports = {
  ...
  appName: process.env.APP_NAME || "Email Validator",
  publisherName: process.env.PUBLISHER_NAME || "emailnphonelist.com",
  supportEmail: process.env.SUPPORT_EMAIL || process.env.GMAIL_USER || "team@emailnphonelist.com",
